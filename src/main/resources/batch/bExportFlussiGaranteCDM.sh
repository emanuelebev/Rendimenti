...
export LOGFILE=${PATH_PFP_LOG}lExportFlussiGaranteCDM.log
export APPO_PATH=/opt/POSTE/appo_file/exportFlussiGarante
export GARANTE_FILENAME_PREFIX=Gar_AP-00564_PK-01498
...
. ${PFP_BATCH}promBatchExtractLogGarante.sh ${PATH_FASI_XML}bExportFlussiGaranteCDM.xml $STARTDATE $ENDDATE $GARANTE_FILENAME_PREFIX $ACTUAL_HM >> $LOGFILE
