...
echo ${JAVA_HOME}java ${JAVA_OPS} -Duser.language=en -Duser.region=US -Xmx7000M -classpath ${PFP_CLASSPATH} it.prometeia.pfpweb.batch.ExecuteJobsRendNoAmbiente $1 $2 $3 $4 $5 $6 $7 $8 $9 -ini ${PFP_INI}
${JAVA_HOME}java ${JAVA_OPS} -Duser.language=en -Duser.region=US -Xmx7000M -classpath ${PFP_CLASSPATH} it.prometeia.pfpweb.batch.ExecuteJobsRendNoAmbiente $1 $2 $3 $4 $5 $6 $7 $8 $9 -ini ${PFP_INI}
