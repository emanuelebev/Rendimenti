...
CURSOR SCARTI_PREZZI IS
    ...
    FROM TMP_PFPREZZI_TITOLI TMP
    	LEFT JOIN STRUMENTOFINANZIARIO SF
   			ON SF.CODICETITOLO = TMP.CODICETITOLO_FIXED
...
FOR CUR_ITEM IN SCARTI_PREZZI
	...
	IF MOD(I,10000) = 0 THEN
	    INSERT INTO OUTPUT_PRINT_TABLE VALUES( TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) ||' SCARTI TMP_PFPREZZI_TITOLI PER CHIAVE ESTERNA (CODICETITOLO) NON CENSITA - COMMIT ON ROW: ' || I);
		COMMIT;
	END IF;

END LOOP;

INSERT INTO OUTPUT_PRINT_TABLE VALUES( TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) ||' SCARTI TMP_PFPREZZI_TITOLI PER CHIAVE ESTERNA (CODICETITOLO) NON CENSITA. RECORD ELABORATI: '|| I);
INSERT INTO OUTPUT_PRINT_TABLE VALUES(TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFPREZZI_TITOLI PER CHIAVE ESTERNA (CODICETITOLO) NON CENSITA. RECORD SCARTATI: ' || SCARTI_CODICETITOLO);
