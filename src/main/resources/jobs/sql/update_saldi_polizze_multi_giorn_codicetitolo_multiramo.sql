...
BEGIN
	...
	IF MOD(I,10000) = 0 THEN
		    INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' UPDATE CODICETITOLO_MULTIRAMO - COMMIT ON ROW: '|| I);
		COMMIT;
	END IF;
	...
	INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' UPDATE CODICETITOLO_MULTIRAMO - COMMIT ON ROW: ' || totale);
	COMMIT;
END;