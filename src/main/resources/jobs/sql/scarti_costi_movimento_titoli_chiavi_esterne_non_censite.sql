...
BEGIN
  ...
  LOOP
    ...
    THEN
      INSERT  
      INTO
        TBL_SCARTI_TMP_PFCOSTI_TITOLI (CODICEBANCA,
								CODICEMOVIMENTO,
								CODICECOSTO,
								IMPORTO,
								FONTE,
	...
	SCARTI_IDRAPPORTO_NUMREG := SCARTI_IDRAPPORTO_NUMREG + 1;
      ...
      DELETE FROM TMP_PFCOSTI_TITOLI DEL_TMP_MOV
    ...
    IF MOD(I, 10000) = 0
    THEN
      INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI_TITOLI PER CHIAVE ESTERNA NON CENSITA - COMMIT ON ROW: ' || I);
      COMMIT;
    END IF;

  END LOOP;
  
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI_TITOLI PER CHIAVE ESTERNA NON CENSITA. NUMERO RECORD ELABORATI: '|| I);
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI_TITOLI FK NON CENSITA (NUMREG/IDRAPPORTO): ' || SCARTI_IDRAPPORTO_NUMREG);
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI_TITOLI FK NON CENSITA (TIPO_COSTO): ' || SCARTI_TIPO_COSTO);
