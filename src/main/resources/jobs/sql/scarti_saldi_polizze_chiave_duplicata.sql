...
BEGIN
	...
	LOOP
	      ...
	      totale := totale + I;
				...
				INSERT INTO tbl_scarti_tmp_pfsaldi_polizze (	codicebanca,
																codiceagenzia,
																codicerapporto,
																codiceinterno,
																ramo,
												...
												VALUES (res_scarti_saldi_pol_mono(j).codicebanca,       
														...
														res_scarti_saldi_pol_mono(j).numero_quote,
									   					res_scarti_saldi_pol_mono(j).nav,
									    				res_scarti_saldi_pol_mono(j).cod_tipo_attivita,
														sysdate,             
			...
			COMMIT;		        
	         ...
	         INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE MONO PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE scarti_saldi_pol_mono;
	
	INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE MONO PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || totale);
	COMMIT;
	      ...
	      totale := totale + I;
				...
				INSERT INTO tbl_scarti_tmp_pfsaldi_polizze (	codicebanca,
												...
												VALUES (res_scarti_saldi_pol_multi(j).codicebanca,       
														...
														res_scarti_saldi_pol_multi(j).numero_quote,
											   			res_scarti_saldi_pol_multi(j).nav,
											    		res_scarti_saldi_pol_multi(j).cod_tipo_attivita,
														sysdate,             
			...
			COMMIT;		        
	         ...
	         INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE MULTI PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE scarti_saldi_pol_multi;
	
	INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE MULTI PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || totale);
	COMMIT;
