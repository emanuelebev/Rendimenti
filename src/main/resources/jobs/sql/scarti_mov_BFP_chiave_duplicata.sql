...
AND TMP.CODICERAPPORTO = A.CODICERAPPORTO;
	...
	LOOP
	      ...
	      TOTALE := TOTALE + I;
				...
				INSERT   INTO TBL_SCARTI_TMP_PFMOV_BFP (	CODICEBANCA,       
															CODICE,            
															CODICEAGENZIA,    
															CODICERAPPORTO,    
															TIPORAPPORTO,      
			        ...
			        DELETE   FROM TMP_PFMOV_BFP TMP_DEL
					WHERE TMP_DEL.ROWID = RES_SCARTI_MOVIMENTI(J).ROWID;
					
					COMMIT;
			        	
	            
	             INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOV_BFP PER CHIAVE (CODICE, CODICEINTERNO, CODICERAPPORTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE SCARTI_MOVIMENTI;
	
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOV_BFP PER CHIAVE (CODICE, CODICEINTERNO, CODICERAPPORTO) DUPLICATA: ' || TOTALE);
	COMMIT;
END;