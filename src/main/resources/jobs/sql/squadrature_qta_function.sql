CREATE OR REPLACE FUNCTION PARALLEL_SQUAD_QTA (
...
BEGIN
		...
		WHEN NOT MATCHED THEN 
            ...
            INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' SQUADRATURE QTA - COMMIT ON ROW: '|| I);
		COMMIT;
