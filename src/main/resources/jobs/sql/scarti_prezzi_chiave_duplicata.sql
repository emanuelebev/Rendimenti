...
FOR CUR_ITEM IN SCARTI_PREZZI
	...
	INSERT   INTO TBL_SCARTI_TMP_PFPREZZI (	CODICEBANCA,               
		...
		INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFPREZZI PER CHIAVE (CODICEBANCA, CODICETITOLO, DATAPREZZO) DUPLICATA - COMMIT ON ROW: '|| I);
		COMMIT; 
		END IF;
				
	END LOOP;
		INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFPREZZI PER CHIAVE (CODICEBANCA, CODICETITOLO, DATAPREZZO) DUPLICATA. RECORD ELABORATI: '|| I);
	COMMIT;
END;