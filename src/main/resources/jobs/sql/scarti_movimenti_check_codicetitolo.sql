...
BEGIN
  ...
  LOOP
    ...
    IF MOD(I, 10000) = 0
    THEN
      INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOVIMENTI PER CAMPO OBBLIGATORIO (CODICEINTERNO) NON VALORIZZATO - COMMIT ON ROW: '|| I);
      COMMIT;
    END IF;
