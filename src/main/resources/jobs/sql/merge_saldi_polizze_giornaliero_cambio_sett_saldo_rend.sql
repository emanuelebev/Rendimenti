...
INSERT (idptf,
	...
	IF MOD(I,10000) = 0 THEN
		    INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' MERGE SALDO_REND POLIZZE WEEK - COMMIT ON ROW: '|| I);
		COMMIT;
	END IF;
	...
	CLOSE merge_saldi_parc;
		...
		INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' MERGE SALDO_REND POLIZZE WEEK - COMMIT ON ROW: ' || totale);
	COMMIT;     
