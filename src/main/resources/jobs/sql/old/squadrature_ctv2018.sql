...
BEGIN
	...
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' Squadrature CTV 2018: ' || TOTALE);
	COMMIT;

	BEGIN

		dbms_stats.gather_table_stats(ownname => sys_context('USERENV', 'CURRENT_SCHEMA'), tabname => 'SQUADRATURE_CTV_2018', degree => 4, estimate_percent=>1); 
	...
	OPEN SQUADRATURE_CTV_DEL;
		LOOP
	      ...
	      COUNT_DELETED := COUNT_DELETED + I;
			...
			INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' Squadrature CTV 2018 eliminate: ' || COUNT_DELETED || ' record'); 
		COMMIT;		        
	...
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' Squadrature CTV 2018. Squadrature eliminate: ' || I);
	COMMIT;
END;
