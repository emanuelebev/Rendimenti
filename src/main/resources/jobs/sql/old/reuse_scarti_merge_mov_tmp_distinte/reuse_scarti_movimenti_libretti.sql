...
FROM TBL_SCARTI_TMP_PFMOV_LIBRETTI SCARTO
LEFT JOIN TMP_PFMOV_LIBRETTI TMP
...
BEGIN
	...
	FOR CUR_ITEM IN DEL_CUR 
		...
		INSERT   INTO TMP_PFMOV_LIBRETTI (CODICEBANCA,
										CODICE,
										CODICEAGENZIA,
										CODICERAPPORTO,
										TIPORAPPORTO,
			...
			DELETE   FROM TBL_SCARTI_TMP_PFMOV_LIBRETTI TBL
			WHERE TBL.ROWID = CUR_ITEM.SCARTO_ROWID;
						
		IF MOD(I,10000) = 0 THEN
			INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' REUSE SCARTI TMP_PFMOV_LIBRETTI. COMMIT ON ROW: ' || I);
			COMMIT;
		END IF;

		END LOOP;
			INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' REUSE SCARTI TMP_PFMOV_LIBRETTI. RECORD RECUPERATI: ' || REUSE_COUNT);
		COMMIT;
