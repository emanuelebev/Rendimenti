...
BEGIN
  ...
  LOOP
    ...
    THEN
      INSERT  
      INTO
        TBL_SCARTI_TMP_PFMOV_FONDI (CODICEBANCA,
                                       CODICE,
                                       CODICEAGENZIA,
                                       CODICERAPPORTO,
                                       TIPORAPPORTO,
      ...
      DELETE   FROM TMP_PFMOV_FONDI DEL_TMP_MOV
...
/*
    ...
    THEN
      INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) ||
                                             ' SCARTI TMP_PFMOV_FONDI PER CHIAVE ESTERNA NON CENSITA - COMMIT ON ROW: '
                                             || I);
      COMMIT;
    END IF;
  ...
  END LOOP;
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) ||
                                         ' SCARTI TMP_PFMOV_FONDI PER CHIAVE ESTERNA NON CENSITA. NUMERO RECORD ELABORATI: '
                                         || I);
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (
    TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOV_FONDI FK NON CENSITA (CODICETITOLO): ' ||
    SCARTI_CODICETITOLO);
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (
    TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOV_FONDI FK NON CENSITA (CODICERAPPORTO): ' ||
    SCARTI_CODICERAPPORTO);
  INSERT INTO OUTPUT_PRINT_TABLE VALUES (
    TO_NUMBER(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFMOV_FONDI NUOVE CAUSALI INSERITE: ' ||
