...
MERGE   INTO
  ...
  USING (
          SELECT
            ...
            TMOV.CODICEINTERNO                                                                               AS CODICETITOLO,
            ...
            SUBSTR(TMOV.CODICERAPPORTO, 0, INSTR(TMOV.CODICERAPPORTO, '-')-1)								 AS CODICERAPPORTO_ORI		
          FROM
            TMP_PFMOVIMENTI TMOV
          INNER JOIN RAPPORTO RAPP
          	ON SUBSTR(TMOV.CODICERAPPORTO, INSTR(TMOV.CODICERAPPORTO, '-')+1)= RAPP.CODICERAPPORTO
          	AND TMOV.CODICEBANCA = RAPP.CODICEBANCA
          	AND TMOV.TIPORAPPORTO = RAPP.TIPO) TOMERGE
  ON
