...
BEGIN
	...
	FOR CUR_ITEM IN SCARTI_SALDI_POLIZZE_MONO
		...
		I := I+1;
			...
			IF MOD(I,10000) = 0 THEN
				INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MONO PER CHIAVE ESTERNA NON CENSITA - COMMIT ON ROW: '|| I);
				COMMIT; 
			END IF;
					
		END LOOP;
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MONO PER CHIAVE ESTERNA NON CENSITA. RECORD ELABORATI: '|| I);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MONO PER CODICETITOLO NON CENSITO. RECORD SCARTATI: '|| SCARTI_CODICETITOLO);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MONO PER CODICERAPPORTO NON CENSITO. RECORD SCARTATI: '|| SCARTI_CODICERAPPORTO);
		COMMIT;
	...
	FOR CUR_ITEM IN SCARTI_SALDI_POLIZZE_MULTI
		...
		I := I+1;
			...
			IF MOD(I,10000) = 0 THEN
				INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MULTI PER CHIAVE ESTERNA NON CENSITA - COMMIT ON ROW: '|| I);
				COMMIT; 
			END IF;
					
		END LOOP;
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MULTI PER CHIAVE ESTERNA NON CENSITA. RECORD ELABORATI: '|| I);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MULTI PER CODICETITOLO NON CENSITO. RECORD SCARTATI: '|| SCARTI_CODICETITOLO);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP MULTI PER CODICERAPPORTO NON CENSITO. RECORD SCARTATI: '|| SCARTI_CODICERAPPORTO);
		COMMIT;
		...
		I := I+1;
			...
			IF MOD(I,10000) = 0 THEN
				INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP ALTRO PER CHIAVE ESTERNA NON CENSITA - COMMIT ON ROW: '|| I);
				COMMIT; 
			END IF;
					
		END LOOP;
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP ALTRO PER CHIAVE ESTERNA NON CENSITA. RECORD ELABORATI: '|| I);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP ALTRO IMPOSSIBILE RICONOSCERE LO STRUMENTO. RECORD SCARTATI: '|| SCARTI_CODICETITOLO);
			 INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALDI_POLIZZE_SP ALTRO PER CODICERAPPORTO NON CENSITO. RECORD SCARTATI: '|| SCARTI_CODICERAPPORTO);
		COMMIT;
	END;