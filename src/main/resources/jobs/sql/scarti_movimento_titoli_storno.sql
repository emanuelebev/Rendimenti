...
CURSOR SCARTI_STORNO IS
	...
	LEFT JOIN TMP_PFMOV_TITOLI TMP2 
...
LOOP 
	...
	INSERT INTO TBL_SCARTI_TMP_PFMOV_TITOLI(CODICEBANCA,
		...
		INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI MOVIMENTI DI STORNO SU TMP_PFMOV_TITOLI - COMMIT ON ROW: '|| I);
		COMMIT; 
		END IF;
				
	END LOOP;
		INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI MOVIMENTI DI STORNO SU TMP_PFMOV_TITOLI. NUMERO RECORD ELABORATI: '|| I);
	COMMIT;
END;