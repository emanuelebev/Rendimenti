...
INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALPOSP_RECUP SCARTI FLAGESCLUSIONE = 1. RECORD ELIMINATI');
