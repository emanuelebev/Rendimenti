...
MERGE    INTO
  ...
  USING (
          SELECT
            tprez.CODICETITOLO_FIXED           							AS CODICETITOLO,
            'C'                              							AS TIPO,
          ...
          FROM
            TMP_PFPREZZI_TITOLI tprez) tomerge
  ON
...
MERGE    INTO
  ...
  INSERT INTO output_print_table VALUES (to_number(to_char(sysdate,'YYYYMMDDHH24MISS')) || ' MERGE SERIE_STORICA DA TMP_PFPREZZI_TITOLI: ' || rowcounts);
	COMMIT;
