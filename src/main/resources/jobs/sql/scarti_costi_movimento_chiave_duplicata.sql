...
AND TMP.TIPORAPPORTO = A.TIPORAPPORTO;
	...
	LOOP
	      ...
	      TOTALE := TOTALE + I;
				...
				INSERT    INTO TBL_SCARTI_TMP_PFCOSTI (CODICEBANCA,       
													CODICEMOVIMENTO,  
													CODICECOSTO,  
													IMPORTO,      
													FONTE,          
	             ...
	             INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI PER CHIAVE (CODICEBANCA,CODICECOSTO,CODICEMOVIMENTO,TIPORAPPORTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE SCARTI_COSTI_MOVIMENTO;
	
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFCOSTI PER CHIAVE (CODICEBANCA,CODICECOSTO,CODICEMOVIMENTO,TIPORAPPORTO) DUPLICATA: ' || TOTALE);
	COMMIT;
END;