...
BEGIN
	...
	LOOP
	      ...
	      TOTALE := TOTALE + I;
				...
				INSERT INTO TBL_SCARTI_TMP_PFSALPOSP_RECUP (	CODICEBANCA,
																CODICEAGENZIA,
																CODICERAPPORTO,
																CODICEINTERNO,
																RAMO,
			...
			DELETE /*+ nologging */ FROM TMP_PFSALPOSP_RECUP TMP_DEL
			WHERE TMP_DEL.ROWID = RES_SCARTI_SALDI_POL_MONO(J).ROWID;
			
			COMMIT;		        
	            
	         INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALPOSP_RECUP MONO PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE SCARTI_SALDI_POL_MONO;
	
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALPOSP_RECUP MONO PER CHIAVE CODICERAPPORTO, CODICEINTERNO, DATAAGGIORNAMENTO) DUPLICATA: ' || TOTALE);
	COMMIT;
	...
	LOOP
	      ...
	      TOTALE := TOTALE + I;
			...
			COMMIT;		        
	         ...
	         INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALPOSP_RECUP MULTI PER CHIAVE CODICERAPPORTO, CODICEINTERNO, RAMO, FONDO, DATAAGGIORNAMENTO) DUPLICATA: ' || I || ' RECORD');
			        
	END LOOP;
	CLOSE SCARTI_SALDI_POL_MULTI;
	
	INSERT INTO OUTPUT_PRINT_TABLE VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YYYYMMDDHH24MISS')) || ' SCARTI TMP_PFSALPOSP_RECUP MULTI PER CHIAVE CODICERAPPORTO, CODICEINTERNO, RAMO, DATAAGGIORNAMENTO) DUPLICATA: ' || TOTALE);
	COMMIT;
